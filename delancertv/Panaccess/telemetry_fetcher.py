...
from delancertv.Panaccess.panaccess_singleton import get_panaccess
from delancertv.models import TelemetryRecordEntryDelancer
        ...
        try:
            ...
            if record.get("timestamp"):
                try:
                    ...
                    timestamp = timezone.make_aware(ts, timezone.get_current_timezone()).astimezone(dt_timezone.utc)
