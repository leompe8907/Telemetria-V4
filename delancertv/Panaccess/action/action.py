...
from delancertv.server.api_key_permission import HasTelemetryWriteApiKey
...
from delancertv.exceptions import PanAccessException, PanAccessAPIError
from datetime import datetime, date

logger = logging.getLogger(__name__)
from delancertv.utils.rate_limit import acquire_rate_limit
...
class MergeOTTView(APIView):
    ...
    def get(self, request):
        ...
        def _get_data(request):
            from delancertv.models import MergedTelemetricOTTDelancer
...
class TelemetryRunView(APIView):
    ...
    def post(self, request):
        ...
        if async_requested:
            ...
            from delancertv.tasks import telemetry_run_task
